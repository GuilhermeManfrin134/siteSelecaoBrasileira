...
export default function Meia1(){

    const { larguraTela, player, meia1, setMeia1, TextoMeias, defensoresConvocados, meiasConvocados, atacantesConvocados } = useContext(UserContext);
    ...
    useEffect(async () => {
      ...
      useEffect(() => {
        localStorage.setItem('meia1', JSON.stringify(meia1));
      }, [meia1]);
