...
export default function Atacante3(){
    ...
    const { larguraTela, player, atacante3, setAtacante3, TextoAtacantes, defensoresConvocados, meiasConvocados, atacantesConvocados } = useContext(UserContext);
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        localStorage.setItem('atacante3', JSON.stringify(atacante3));
      }, [atacante3]);
