...
export default function Atacante4(){
    ...
    const { larguraTela, player, atacante4, setAtacante4, TextoAtacantes, defensoresConvocados, meiasConvocados, atacantesConvocados } = useContext(UserContext);
    ...
    useEffect(async () => {
      ...
      useEffect(() => {
        localStorage.setItem('atacante4', JSON.stringify(atacante4));
      }, [atacante4]);
