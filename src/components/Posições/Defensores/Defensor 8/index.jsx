...
export default function Defensor8(){

    const { larguraTela, player, defensor8, setDefensor8, TextoDefensores, defensoresConvocados, meiasConvocados, atacantesConvocados } = useContext(UserContext);
