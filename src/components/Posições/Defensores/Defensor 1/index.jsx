...
export default function Defensor1(){

    const { larguraTela, player, defensor1, setDefensor1, TextoDefensores, defensoresConvocados, meiasConvocados, atacantesConvocados } = useContext(UserContext);
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        localStorage.setItem('defensor1', JSON.stringify(defensor1));
      }, [defensor1]);
