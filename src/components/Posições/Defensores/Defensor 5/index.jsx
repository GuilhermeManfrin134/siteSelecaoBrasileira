...
export default function Defensor5(){

    const { larguraTela, player, defensor5, setDefensor5, TextoDefensores, defensoresConvocados, meiasConvocados, atacantesConvocados } = useContext(UserContext);
    ...
    useEffect(async () => {
      ...
      useEffect(() => {
        localStorage.setItem('defensor5', JSON.stringify(defensor5));
      }, [defensor5]);
